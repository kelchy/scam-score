...
const parentMessageId = '643f740c-0b9e-4dfb-ac28-c113c1931c09'
...
async function score (sender, message) {
    ...
    const { data, error } = await common.awaitWrap(chatGptClient.sendMessage(question, { conversationId, parentMessageId }), { timeout: 25000 })
    if (error) {
